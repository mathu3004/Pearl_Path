    ...
    for day in range(num_days):
        ...
        final_itinerary["days"].append({
            ...
            "hotel": {
                ...
                "address": current_hotel.get('address', '')
            },
            "meals": {
                "breakfast": {
                    ...
                    "address": breakfast_restaurant.get('address', '')
                },
            "lunch": {
            ...
            "attractions": [
                {
                    ...
                    "weburl": attraction_1.get('weburl', ''),
                    "address": attraction_1.get('Address', '')
                },
                {
                    ...
                    "weburl": attraction_2.get('weburl', ''),
                    "address": attraction_2.get('Address', '')
                }
            ],
