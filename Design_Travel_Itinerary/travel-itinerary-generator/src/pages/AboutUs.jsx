...
const AboutUs = () => {
    return (
        ...
        >
            ...
            <h1 style={{ textAlign: "center", marginBottom: "40px", color: "#333" , fontWeight: "bold" }}>
                About Us
            </h1>
            <div
                style={{
            ...
            >
                ...
                >
                    ...
                    <p style={{ color: "#555", lineHeight: 1.6 }}>
                        ...
                        generation model, ensuring each itinerary is dynamically tailored
                        to individual preferences for an exceptional travel experience.
                    </p>
                </div>
