  ...
  return (
    <header className="flex items-center justify-between bg-gray-800 text-white px-6 py-4">
      ...
      <nav className="space-x-6">
        ...
        <a href="/itinerary" className="hover:text-gray-300">
          Itinerary
        </a>
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        >
          <div className="col-span-2">
            <label className="block font-semibold mb-1">Itinerary Name:</label>
            <input
              type="text"
              name="name"
          ...
          <div className="col-span-2">
            <label className="block font-semibold mb-1">Destinations:</label>
